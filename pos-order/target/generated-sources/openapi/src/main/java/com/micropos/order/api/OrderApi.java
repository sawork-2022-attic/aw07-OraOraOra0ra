...
public interface OrderApi {
    ...
    default ResponseEntity<Long> createOrder(
        @Parameter(name = "OrderDto", description = "", schema = @Schema(description = "")) @Valid @RequestBody(required = false) OrderDto orderDto
    ) {
     ...
     *
     * @return Orders found (status code 200)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Orders found", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  OrderDto.class))),
            @ApiResponse(responseCode = "404", description = "Orders not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  ErrorDto.class)))
        }
    )
    @RequestMapping(
